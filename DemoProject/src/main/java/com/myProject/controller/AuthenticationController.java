...
import com.myProject.jwtRequest.*;
import com.myProject.jwtResponse.JwtResponse;
...
import com.myProject.services.UserDetailsImplementation;
import com.myProject.jwt.JwtUtils;
...
public class AuthenticationController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByRoleName(EnumRoles.ROLE_USER)
			...
			strRoles.forEach(role -> {
				switch (role) {
				case "admin":
					Role adminRole = roleRepository.findByRoleName(EnumRoles.ROLE_ADMIN)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(adminRole);
